...
public class places_adapter extends ArrayAdapter<places_adapter.PlaceAutocomplete> implements Filterable {
    ...
    public places_adapter(Context context, int resource, RectangularBounds bounds) {
